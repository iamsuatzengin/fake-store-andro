...
import com.example.product.home.adapter.RecyclerViewItemDecoration
import com.example.product.home.adapter.product.ProductAdapter
import com.example.product.home.adapter.category.CategoryAdapter
...
class HomeFragment : Fragment(R.layout.fragment_home), ProductAdapterCallback {
    ...
    private fun setupCategoryRecyclerView() {
        ...
        categoryAdapter.submitList(CategoryType.entries)
